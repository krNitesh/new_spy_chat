...
def add_status():#function to update or add status
    ...
    if spy.current_status_message != None:
        ...
        print 'your current status_message %s \n' % (spy.current_status_message)
    else:
        print 'sorry! You do not have any current status_message \n'

    default = raw_input("Do you want to select from your older status (y/n)? ")

    if default.upper() == "N":
        new_status_message = raw_input("Set status_message of your choice Y ")
...
def read_message():#function to read latest message
    ...
    secret_text = Steganography.decode(raw_input("enter the name of file"))
...
def start_chat(spy): #function to start a chat
    ...
    if spy.age > 12 and spy.age < 50:
        ...
        print "Authentication complete. Welcome " + spy.name + " age: " \
              + str(spy.age) + " and rating of: " + str(spy.rating) + " Here you go!"
